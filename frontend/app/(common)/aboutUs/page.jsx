      ...
      <div className="min-h-screen">
        <div className="w-full py-6 flex flex-col">
          ...
          <section className="mb-8 ml-3">
            <h2 className="font-bold text-2xl mb-2">Why You Should Join Us?</h2>
            <p className="max-w-2xl text-gray-900">
              ...
              personalized health journey that represents your unique goals
              rather than just browsing. You'll be able to access a variety of
              healthy recipes, meal plans, and educational content tailored to
              your needs. You'll also be able to track your weight and BMI to
              see how your health is improving over time.
              <br />
              <br />
              For businesses, elevate your brand and connect with a
              health-conscious audience on the Healthy Recipe Diet platform. We
              provide a dynamic space for you to showcase your knowledge and
              expertise. You will be able to create blog posts featuring on our
              website. You can also create and share recipes and educational
              content with our users. We'll help you reach a new audience and
              grow your business.
              <br />
              <br />
              For dietitians, we provide a platform for you to share your
              knowledge and expertise with our users. You can create and share
              meal plans with our users. We'll help you reach a new audience and
              grow your business.
            </p>
          </section>
