...
public class WebSecurityConfig {
    ...
    // passwordEncoder -> securityFilterChain -> configure -> filterChain -> authenticationManager
    // @Bean
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
            .csrf(csrf-> csrf.disable())
            // Disabling CSRF protection means that Spring Security won't generate and validate these tokens. 
            // While this solves the issue for now, it's important to understand that disabling CSRF protection 
            // can expose your application to CSRF attacks. It's generally recommended to keep CSRF protection 
            // enabled and properly configure your frontend code to include and send the CSRF token with each request.
