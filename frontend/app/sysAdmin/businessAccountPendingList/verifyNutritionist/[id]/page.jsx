          ...
          <div className="rounded-md space-y-3">
            <div>
              ...
              <input
                ...
                value={userAccount ? userAccount.username : "N/A"}
                readOnly
            ...
            <div>
              ...
              <input
                ...
                id="name"
                autoComplete="name"
                value={userAccount ? userAccount.fullName : "N/A"}
                readOnly
                className="border-1 border-blue-700 rounded-md py-2 px-4 w-full"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                value={userAccount ? userAccount.contactNumber : "N/A"}
                readOnly
                className="border-1 border-blue-700 rounded-md py-2 px-4 w-full"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                id="email"
                autoComplete="email"
                value={userAccount ? userAccount.email : "N/A"}
                readOnly
                className="border-1 border-blue-700 rounded-md py-2 px-4 w-full"
              />
            </div>
