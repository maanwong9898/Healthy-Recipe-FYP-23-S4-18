-- Note that this is for development purposes only. This is not the final version of the database.
-- The final database will be from each individual sql file.
...
VALUES
    ...
    (
        ...
        1, -- userId
        'https://www.freepik.com/free-phofood-kitchen-desk_13061154.htm#query=kitchen%20knives%20and%20measuring%20equipments&position=42&from_view=search&track=ais&uuid=b65f9b16-99c8-4cb1-b7b3-a45522feccca',
    ...
    (
        ...
        1, -- userId
        'https://img.freepik.com/frves-grey-table_140725-145666.jpg?w=996&t=st=1707023966~exp=1707024566~hmac=3b117a6b06320db35cdb78f3de40f95f597b9739efdddee941f4301251cc956c',
    ...
    (
        ...
        1, -- userId
        'https://img.freepik.com/ts-violi-pasta-square-format-suitable-wallpaper-wrapping-paper-fabric_1284-44086.jpg?w=740&t=st=1707062743~exp=1707063343~hmac=7c803cf6fbff4ff14301668112c4d89f4e6f7782e935437899406dac7dba904c',
        'Author: macrovector, Designed by Freepik',  -- img_title
        2 -- blog_type_id kitchenware
    ),
    (
    ...
    (
        ...
        1, -- userId
        'https://img.freepik.com/freod-vegetarian-dinner-table_2829-6473.jpg?w=996&t=st=1707225891~exp=1707226491~hmac=5c8bc78a72585f98fc92d5ee1264eec2896c502277c9e9311c6e2e12808de4ce',
    ...
    (
        ...
        1, -- userId
        'https://img.freepik.com/frle-kitchen_639032-170.jpg?w=996&t=st=1707227020~exp=1707227620~hmac=a29ec81d2222ff77fc36eb36b3c0f3e1af9c530c0b94daac0e3abf4bc83ae10b',
...
VALUES
    ...
    (
        ...
        TRUE,
        '2023-01-11 15:30:00',
        'https:/sweet%20potato%20salad%20recipe&position=43&from_view=search&track=ais&uuid=46b3221c-38e4-4e4d-a2ea-1e748f23e6b0',
        'Author : EyeEm, Designed by Freepik',  -- img_title
        2, -- dietary_preference
        30, -- cooking_time
        9   -- meal type (cuisines)
    ...
    (
        ...
        TRUE,
        '2023-01-02 08:00:00',
        'https://www.sis__resources__content_migration__simply_recipes__uploads__2006__01__baked-lingcod-horiz-a-1200-2e25188b62634d30a991b2b29270a5e5.jpg',
        'Author : Elise Bauer, Designed by simplyrecipes',  -- img_title
        3, -- dietary_preference
        15, -- cooking_time
        2   -- meal type (cuisines)
    ...
    (
        ...
        TRUE,
        '2023-06-03 09:30:00',
        'https://www.simplyret__aboutcom__coeus__resources__content_migration__simply_recipes__uploads__2017__06__2017-07-22-FishTacos-5-baa8171933fe40f0b737d448b4c47788.jpg',
    ...
    (
        ...
        TRUE,
        '2023-06-03 09:30:00',
        'https://www.simplyrecipes.cutcom__coeus__resources__content_migration__simply_recipes__uploads__2016__02__dads-fish-stew-horiz-a-1600-8cf962c81e084558a025bf8392e00f32.jpg',
        'Author : Elise Bauer, Designed by simplyrecipes',  -- img_title
        3, -- dietary_preference
        20, -- cooking_time
        9   -- meal type (cuisines)
...
(
    ...
    '2023-04-10',
    3, -- weight loss
    'https://img.freepik.comes-tomatoes-grey-vegetable-food-meal-breakfast_140725-18886.jpg?w=1060&t=st=1707559930~exp=1707560530~hmac=ab1891ed1eced001a2948ec254058a04b7c75f2be2ace362e350369897452ed9',
    'Designed by Freepik',  -- img_title
    '2' -- userid
),
(
...
VALUES
    ...
    ('The recipe is very nice',                         5.0, '8', 2),
