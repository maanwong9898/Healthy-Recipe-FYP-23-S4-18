...
// rouuter path: /registeredUser/educationalContent
...
const EducationalContentPageForUser = () => {
  ...
  useEffect(() => {
    const getData = async () => {
      ...
      setAllEduContent(fetchedEduContent);
      setDisplayedEduContent(fetchedEduContent);
    };
    getData();
  ...
  useEffect(() => {
    const filterPosts = () => {
      ...
      setDisplayedEduContent(filteredPosts);
  ...
  }, [searchTerm, categoryFilter, AllEduContent]);
    ...
    if (!searchTerm.trim()) {
      ...
      try {
        ...
        if (filteredResults.length > 0) {
          setDisplayedEduContent(filteredResults);
